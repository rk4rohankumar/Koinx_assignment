...
const AboutBitcoin = () => {
    return (
        <div className='flex flex-col  bg-white rounded-lg font-semibold' >
            <h1 className='text-3xl p-5 font-semibold'>About Bitcoin</h1>
            <div className=' px-5'>
            ...
            <div className='m-5'>
                <h1 className='text-2xl'>Bitcoin Price</h1>
                ...
                <div className='  '>
                    ...
                    <div className='flex border-b-2 pb-3'>
                        <AboutCard backgroundColor={'blue'} imageSrc={"https://thumbor.forbes.com/thumbor/fit-in/900x510/https://www.forbes.com/advisor/au/wp-content/uploads/2023/08/piggybank-sK-ziQvKGsk-unsplash-scaled-e1691736853555.jpg"} heading1={"Calculate your profit"} buttonLabel={"Check now"}></AboutCard>
                        <AboutCard backgroundColor={'red'} imageSrc={"https://thumbor.forbes.com/thumbor/fit-in/900x510/https://www.forbes.com/advisor/au/wp-content/uploads/2023/08/piggybank-sK-ziQvKGsk-unsplash-scaled-e1691736853555.jpg"} heading1={"Calculate your profit"} buttonLabel={"Check now"}></AboutCard>
                    </div>
                    <div className='my-3'>
